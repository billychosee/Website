  ...
  return (
    <div className='pt-24 text-black bg-white'>
      ...
      <div className="flex flex-col items-center space-y-6 text-center py-14">
        ...
        <h1 className="!text-[#4A90A4] !text-3xl xl:!text-[53px] !font-bold lg:!text-4xl">Why choose us for your <br /> development project?</h1>
...
<section className="flex flex-col gap-10 pt-10 pb-10 md:pb-24 px-5 text-black md:px-24 md:flex-row bg-[#d5f3ff]">
  {[
    {
      icon: <FaLaptopCode size={40} className="text-[#4A90A4] hover:text-[#8DC440]" />,
      title: "web development",
    ...
    {
      icon: <FaMobileAlt size={40} className="text-[#4A90A4] hover:text-[#8DC440]" />,
    ...
    {
      icon: <FaShoppingCart size={40} className="text-[#4A90A4] hover:text-[#8DC440]" />,
